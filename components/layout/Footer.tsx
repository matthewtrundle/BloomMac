        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center">
              <div className="relative h-12 w-32 bg-white rounded-md overflow-hidden">
                <Image 
          ...
          {/* Services */}
          <div>
            <h3 className="text-xl font-playfair font-medium mb-4">Our Services</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-playfair font-medium mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/about"
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-xl font-playfair font-medium mb-4">Contact Us</h3>
