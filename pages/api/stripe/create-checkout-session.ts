...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Courses are currently disabled
    if (process.env.COURSES_ENABLED !== 'true') {
      return res.status(503).json({ error: 'Course purchases are coming soon! Launching July 2025.' });
    }
