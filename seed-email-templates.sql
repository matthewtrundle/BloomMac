-- This script seeds the email_templates table with the templates that were previously hardcoded in the application.

INSERT INTO email_templates (name, subject, content, category, variables) VALUES
('Newsletter Welcome', 'Welcome to Your Journey of Growth with Bloom Psychology 🌸', '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
</html>', 'newsletter', '["firstName", "unsubscribeLink"]'),
('Contact Form Follow-up', 'Thank you for reaching out', '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Thank you for reaching out to Bloom Psychology. We''ve received your message and will get back to you within 1-2 business days.</p>
      
      <p>In the meantime, feel free to explore our <a href="https://www.bloompsychologynorthaustin.com/blog">blog</a> for helpful articles and resources.</p>
