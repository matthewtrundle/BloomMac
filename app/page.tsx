      ...
      <section className="py-20 bg-gradient-to-br from-bloom-sage-50/30 to-bloom-pink-50/30">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Save up to $1,203 with our expertly curated packages that combine courses, support, and premium add-ons.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="p-6">
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-500 mb-1">Bronze</p>
                  <h3 className="text-xl font-bold text-[#1e3a5f]">Getting Started</h3>
                  <div className="mt-3">
                    <span className="text-3xl font-bold text-amber-600">$397</span>
                    <span className="text-gray-400 line-through ml-2">$491</span>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-amber-600 rounded-full mt-1.5"></div>
                    <span>Any 1 Course</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-amber-600 rounded-full mt-1.5"></div>
                ...
                <Link href="/packages" className="block text-center bg-[#1e3a5f] text-white px-4 py-2 rounded-lg hover:bg-[#152a47] transition-colors text-sm font-medium">
                  Learn More
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
              viewport={{ once: true }}
              className="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-all ring-2 ring-[#f8b5c4] relative"
            >
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#f8b5c4] text-white px-4 py-1 rounded-full text-xs font-medium">
                Most Popular
              </div>
              ...
              <div className="p-6">
                <div className="text-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-[#1e3a5f]">Comprehensive</h3>
                  <div className="mt-3">
                    <span className="text-3xl font-bold text-gray-600">$1,297</span>
                    <span className="text-gray-400 line-through ml-2">$1,618</span>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-gray-600 rounded-full mt-1.5"></div>
                    <span>Postpartum Course</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-gray-600 rounded-full mt-1.5"></div>
                ...
                <Link href="/packages" className="block text-center bg-[#f8b5c4] text-white px-4 py-2 rounded-lg hover:bg-[#f8b5c4]/90 transition-colors text-sm font-medium">
                  Learn More
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all"
            >
              <div className="h-2 bg-gradient-to-r from-yellow-600 to-yellow-700"></div>
              <div className="p-6">
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-500 mb-1">Gold</p>
                  <h3 className="text-xl font-bold text-[#1e3a5f]">Transformation</h3>
                  <div className="mt-3">
                    <span className="text-3xl font-bold text-yellow-600">$1,897</span>
                    <span className="text-gray-400 line-through ml-2">$2,415</span>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-yellow-600 rounded-full mt-1.5"></div>
                    <span>All 3 Courses</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-yellow-600 rounded-full mt-1.5"></div>
            ...
            >
              ...
              <div className="p-6">
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-500 mb-1">Platinum</p>
                  <h3 className="text-xl font-bold text-[#1e3a5f]">VIP Experience</h3>
                  <div className="mt-3">
                    <span className="text-3xl font-bold text-purple-600">$3,997</span>
                    <span className="text-gray-400 line-through ml-2">$5,200</span>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-purple-600 rounded-full mt-1.5"></div>
                    <span>8 Sessions w/ Dr. Jana</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1 h-1 bg-purple-600 rounded-full mt-1.5"></div>
          ...
          <div className="text-center mt-8">
            <Link href="/packages" className="inline-flex items-center text-[#f8b5c4] hover:text-[#1e3a5f] font-medium transition-colors">
