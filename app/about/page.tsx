          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              >
                ...
                {/* Professional divider */}
                <div className="w-16 h-0.5 bg-bloom/20 mb-8"></div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            {/* Professional divider */}
            <div className="w-32 h-0.5 bg-bloom/20 mx-auto mb-8"></div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-playfair text-bloom text-3xl md:text-4xl mb-8">
              ...
              {/* Professional divider */}
              <div className="w-32 h-0.5 bg-bloom/20 mx-auto"></div>
            </motion.div>
            
            <div className="space-y-12">
              <GlassmorphismPanel variant="medium" className="p-8 space-y-12">
                <motion.div 
                  className="border-l-4 border-bloompink pl-6"
                  initial={{ opacity: 0, x: -20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="font-playfair text-xl text-bloom mb-3">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <h2 className="font-playfair text-4xl md:text-5xl font-bold text-bloom mb-6">
                Professional, Personal, Present
              </h2>
              <p className="text-bloom/70 max-w-3xl mx-auto text-lg">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="bg-white p-8 rounded-2xl shadow-soft">
                  <h3 className="font-playfair text-2xl text-bloom mb-6">Education & Training</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <span className="text-bloompink mr-3">✓</span>
                      <span className="text-bloom/80">Doctorate in Clinical Psychology, Specialization in Maternal Mental Health</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-bloompink mr-3">✓</span>
                      <span className="text-bloom/80">Advanced Certification in Perinatal Mental Health</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-bloompink mr-3">✓</span>
                      <span className="text-bloom/80">EMDR Trained for Birth Trauma & Postpartum PTSD</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-bloompink mr-3">✓</span>
                      <span className="text-bloom/80">Gottman Method Couples Therapy (Level 2)</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-white p-8 rounded-2xl shadow-soft">
                  <h3 className="font-playfair text-2xl text-bloom mb-6">Areas of Expertise</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-bloom/80 text-sm">• Postpartum Depression</div>
                    <div className="text-bloom/80 text-sm">• Birth Trauma Recovery</div>
                    <div className="text-bloom/80 text-sm">• Pregnancy Anxiety</div>
                    <div className="text-bloom/80 text-sm">• Identity Transitions</div>
                    <div className="text-bloom/80 text-sm">• Relationship Changes</div>
                    <div className="text-bloom/80 text-sm">• Fertility Challenges</div>
                    <div className="text-bloom/80 text-sm">• Pregnancy Loss</div>
                    <div className="text-bloom/80 text-sm">• Partner Support</div>
                  </div>
                </div>
              </motion.div>
            </div>
