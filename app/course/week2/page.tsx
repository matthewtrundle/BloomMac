...
const lessons = [
  {
    id: 1,
    title: 'The Postpartum Mind - Understanding Your Thoughts',
    description: 'Normalizing the mental chaos and understanding your transformed brain',
    duration: '11 minutes',
    slides: 17,
    status: 'ready',
    path: '/course/week2/lesson1'
  },
  {
    id: 2,
    title: 'Cognitive Defusion - Unhooking from Difficult Thoughts',
    description: 'Learn to create space between you and your thoughts',
    duration: '13 minutes',
    slides: 19,
    status: 'ready',
    path: '/course/week2/lesson2'
  },
  {
    id: 3,
    title: 'Core Beliefs & Identity Shifts',
    description: 'Navigate the profound changes in how you see yourself',
    duration: '14 minutes',
    slides: 16,
    status: 'ready',
    path: '/course/week2/lesson3'
  },
  {
    id: 4,
    title: 'Cognitive Wellness Integration',
    description: 'Building sustainable practices for mental clarity',
    duration: '12 minutes',
    slides: 15,
    status: 'ready',
    path: '/course/week2/lesson4'
  }
];
...
const resources = [
  {
    ...
    description: 'Thought tracking & cognitive exercises',
    link: '/resources/week2-workbook.pdf'
  },
  {
    icon: Headphones,
    title: 'Guided Meditation',
    description: '12-minute cognitive defusion practice',
    link: '/resources/week2-meditation.mp3'
  },
  {
    icon: Users,
    title: 'Community Forum',
    description: 'Share insights with other moms',
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-playfair text-bloom-dark">Week 2: Cognitive Transformation</h1>
              <p className="text-bloom-dark/60 mt-2">From Chaos to Clarity</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Resources */}
          <div>
            <h2 className="text-2xl font-semibold mb-6">Week 2 Resources</h2>
            <div className="space-y-4">
            ...
            <motion.div
              ...
              className="mt-8 bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-xl p-6"
            >
              ...
              <p className="text-sm opacity-80">
                Master cognitive transformation techniques!
              </p>
            </motion.div>
          </div>
        </div>
