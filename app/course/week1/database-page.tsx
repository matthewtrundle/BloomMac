...
export default function Week1DatabasePage() {
  ...
  const fetchWeekContent = async () => {
    try {
      const response = await fetch('/api/course/content?courseSlug=postpartum-wellness-foundations&weekNumber=1');
      if (!response.ok) throw new Error('Failed to fetch content');
      
      const data = await response.json();
      setModule(data.module);
      setLessons(data.module.course_lessons || []);
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-bloom-sage-50 via-white to-bloom-pink-50">
            ...
            <div>
              ...
              {module.objectives && module.objectives.length > 0 && (
                <div className="mt-4">
                  ...
                  <ul className="list-disc list-inside text-bloom-dark/70">
      ...
      <div className="container mx-auto px-6 py-12 relative z-10">
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                >
                  <Link
                    href={lesson.is_published 
                      ? `/course/week${module.week_number}/lesson${lesson.lesson_number}` 
                      : '#'}
          ...
          {/* Resources */}
          <div>
            <h2 className="text-2xl font-semibold mb-6">Week {module.week_number} Resources</h2>
            <div className="space-y-4">
            ...
            >
              ...
              <p className="text-sm opacity-80">
                Complete all lessons to unlock your Week {module.week_number} certificate!
              </p>
            </motion.div>
          </div>
        </div>
