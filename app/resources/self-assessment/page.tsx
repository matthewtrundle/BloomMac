...
export default function SelfAssessmentPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Introduction Section with Garden Theme */}
            ...
            <GlassmorphismPanel variant="medium" className="p-8 bg-gradient-to-br from-white to-bloom-sage-50/20 border border-bloom-sage/10">
              <div className="prose prose-lg max-w-none">
                <p className="text-bloom/80 leading-relaxed text-lg">
                  Sometimes it's challenging to distinguish between normal life stress and when it might be time 
                  to seek professional support. This gentle self-assessment is designed to help you check in with yourself 
                  and recognize patterns that might benefit from mental health care.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-bloom/90 mb-0 font-medium">
                        <strong>Important Note:</strong> This is not a diagnostic tool. It's simply a way to reflect on your 
                        experiences and feelings. Trust your instincts—if something feels concerning, it's always worth exploring 
      ...
      {/* Assessment Sections with Garden Theme */}
        ...
        <div className="max-w-3xl mx-auto space-y-12 relative z-10">
          ...
          >
            <GlassmorphismPanel variant="medium" className="p-8 bg-gradient-to-br from-white to-bloom-pink-50/20 border border-bloom-pink/10">
              ...
              <p className="text-bloom/70 mb-8 text-lg">Check any that apply to you most days:</p>
              ...
              <div className="space-y-5">
                <motion.label 
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloompink border-bloom-sage/30 rounded focus:ring-bloompink" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">I feel sad, empty, or hopeless more often than not</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-pink-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloompink border-bloom-sage/30 rounded focus:ring-bloompink" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">I have lost interest in activities I used to enjoy</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-pink-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloompink border-bloom-sage/30 rounded focus:ring-bloompink" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">I feel anxious, worried, or on edge frequently</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-pink-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloompink border-bloom-sage/30 rounded focus:ring-bloompink" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">My emotions feel out of control or overwhelming</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-pink-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloompink border-bloom-sage/30 rounded focus:ring-bloompink" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">I feel numb or disconnected from my feelings</span>
                </motion.label>
              </div>
            </GlassmorphismPanel>
          </motion.div>
          ...
          >
            <GlassmorphismPanel variant="medium" className="p-8 bg-gradient-to-br from-white to-bloom-sage-50/20 border border-bloom-sage/10">
              <h2 className="text-3xl font-playfair font-semibold text-bloom-dark mb-6 flex items-center">
                <CheckCircle2 className="w-8 h-8 text-bloom-sage mr-4" />
                Physical Symptoms
              </h2>
              
              <p className="text-bloom/70 mb-8 text-lg">Notice any of these physical experiences:</p>
              ...
              <div className="space-y-5">
                <motion.label 
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloom-sage border-bloom-sage/30 rounded focus:ring-bloom-sage" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">Significant changes in sleep (too much or too little)</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-sage-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloom-sage border-bloom-sage/30 rounded focus:ring-bloom-sage" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">Changes in appetite or weight</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-sage-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloom-sage border-bloom-sage/30 rounded focus:ring-bloom-sage" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">Persistent fatigue or low energy</span>
                </motion.label>
                <motion.label 
                  className="flex items-start cursor-pointer group p-3 rounded-lg hover:bg-bloom-sage-50/30 transition-colors"
                  whileHover={{ x: 5 }}
                ...
                >
                  <input type="checkbox" className="mt-1.5 mr-4 w-5 h-5 text-bloom-sage border-bloom-sage/30 rounded focus:ring-bloom-sage" />
                  <span className="text-bloom/80 group-hover:text-bloom-dark transition-colors">Difficulty concentrating or making decisions</span>
                </motion.label>
              </div>
            </GlassmorphismPanel>
          </motion.div>
            ...
            <GlassmorphismPanel variant="medium" className="p-8 bg-gradient-to-br from-white to-bloom-sage-50/30 border border-bloom-sage/20">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-green-700">You might be experiencing normal life stress. Consider incorporating self-care practices, 
                  reaching out to friends, or trying stress-reduction techniques. These are healthy ways to manage everyday challenges.</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-orange-700">You may be going through a challenging time that could benefit from professional support. 
                  Therapy can provide evidence-based tools and strategies to help you navigate these difficulties and build resilience.</p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-red-700 mb-4">Please reach out for help immediately. You don't have to go through this alone:</p>
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 leading-relaxed">
              ...
              professional support, we're here to help you on your healing journey.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button href="/book" variant="pink" size="lg" className="shadow-lg hover:shadow-xl">
