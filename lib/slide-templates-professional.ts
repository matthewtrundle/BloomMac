/**
 * Professional E-Learning Slide Templates
 * World-class designs for postpartum wellness education
 */

export const professionalSlideTemplates = {
  // Hero Welcome Slide - Creates immediate emotional safety
  heroWelcome: (content: any) => `
    ...
    <div class="slide-container safe-container">
      ...
      <div class="container-grid">
        <div class="container-column is-column">
          ...
          <ul class="item-list">
            ${content.thisIs.map((item: string) => `<li>${item}</li>`).join('')}
          </ul>
        </div>
        ...
        <div class="container-column is-not-column">
          ...
          <ul class="item-list">
            ${content.thisIsNot.map((item: string) => `<li>${item}</li>`).join('')}
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="practice-wrapper">
        ...
        <div class="practice-card">
          ...
          <div class="practice-steps">
            ${content.practice.steps.map((step: string) => `
  ...
  closingIntegration: (content: any) => `
      ...
      <div class="closing-wrapper">
        ...
        <div class="takeaways">
          ...
          <ul class="takeaway-list">
            ${content.takeaways.map((takeaway: string) => `
