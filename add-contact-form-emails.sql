...
-- Contact Form Follow-up: 3 emails over 7 days

-- Email 1: Immediate Response (sent immediately)
INSERT INTO sequence_emails (
    ...
    gen_random_uuid(),
    '9f454fab-a3e2-4af4-a680-f65bceadf3a9',
    1,
...
-- Email 2: 72 Hour Follow-up (3 days after contact)
INSERT INTO sequence_emails (
    id,
    sequence_id,
    position,
    ...
    '9f454fab-a3e2-4af4-a680-f65bceadf3a9',
    2,
    'Thinking of you - Resources while you wait 💕',
    '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
-- Email 3: Week 1 Resources (7 days after contact)
INSERT INTO sequence_emails (
    id,
    sequence_id,
    position,
...
SELECT 
    ...
    delay_days,
    CASE 
        WHEN delay_hours = 0 AND delay_days = 0 THEN 'Immediate'
        WHEN delay_days > 0 THEN delay_days || ' days'
        ELSE delay_hours || ' hours'
    END as timing
FROM sequence_emails 
WHERE sequence_id = '9f454fab-a3e2-4af4-a680-f65bceadf3a9' 
ORDER BY position;